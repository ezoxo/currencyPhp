<?
//методы данного класса реализованны через хранение комбинаций 2х валют в формате ISO, класс имеет возможность делать обратную конверсию через высчитанный искусственный обратный курс, в классе можно сделать загрузку настоящего обратного курса, тоесть например конвертация валюты 2 в валюту 1
